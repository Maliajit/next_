    ...
    <div className="w-full px-6 lg:px-10 xl:px-16 py-6">
      <div className="max-w-[1600px] mx-auto">
        <PageHeader
          ...
          subtitle="Manage images for The Atelier Chronicles section on the homepage"
        ...
        <div style={{
          ...
          <div style={{
            ...
            <span style={{ fontSize: 12, color: '#9ca3af' }}>
              Drag images in The Atelier Chronicles carousel
            </span>
          </div>
          ...
          <div style={{ padding: 24 }}>
            {loading ? (
              ...
              <div style={{
                ...
                <p style={{ fontSize: 13 }}>Add your first community image to showcase in The Atelier Chronicles</p>
                <button
                  onClick={handleAdd}
                  style={{
