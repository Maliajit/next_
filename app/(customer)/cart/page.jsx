...
export default function Cart() {
  ...
  const subtotal = items.reduce((s, i) => s + (i.price ? parseFloat(i.price.replace('$', '').replace(',', '')) : 0) * i.qty, 0);
      ...
      <div className="cart-layout">
        ...
        >
          <div className="cart-summary-card">
            ...
            <div className="cart-summary-line">
              <span>Shipping</span>
              <span>{shipping === 0 ? <span className="cart-free-tag">Free</span> : `$${shipping}`}</span>
            </div>
            {shipping > 0 && (
              <div className="cart-free-hint">Spend ${(1500 - subtotal + 1).toLocaleString()} more for free shipping</div>
            )}
