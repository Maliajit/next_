...
export default function ForgotPasswordPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!email || !password || !confirmPassword) {
      setError('Please enter your email, new password, and confirmation.');
      return;
    }
    ...
    setSubmitting(true);
    try {
      console.log('[auth-ui] forgot password submit', { email, passwordLength: password.length });
      const result = await resetPasswordApi({ email: email.trim(), password });
    ...
    <div className="fp-page">
      <div className="fp-card">
        <div className="fp-header">
          ...
          <p className="fp-subtitle">Enter your email and the new password you want to use.</p>
        </div>
