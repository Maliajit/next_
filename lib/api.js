...
export const fetchPolicy = (id) => request('GET', /policies/);
export const createPolicy = (data) => request('POST', '/policies', data);
export const updatePolicy = (id, data) => request('PUT', /policies/, data);
export const deletePolicy = (id) => request('DELETE', /policies/);
